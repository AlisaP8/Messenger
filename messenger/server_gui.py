...
if __name__ == '__main__':
    ...
    test_list.appendRow(
        [QStandardItem('test1'), QStandardItem('192.125.10.5'), QStandardItem('23544'), QStandardItem('18:20:00')])
    test_list.appendRow(
        [QStandardItem('test2'), QStandardItem('192.125.0.18'), QStandardItem('33245'), QStandardItem('16:22:11')])
    ...
    # test_list.appendRow(
    #     [QStandardItem('test1'), QStandardItem('Sut Dec 22 18:20:00 2021'), QStandardItem('2'), QStandardItem('3')])
    # test_list.appendRow(
